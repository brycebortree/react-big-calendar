...
var Calendar = function (_React$Component) {
  ...
  Calendar.prototype.render = function render() {
    var _props = this.props,
        ...
        min = _props.min,
        max = _props.max,
        props = _objectWithoutProperties(_props, ['view', 'toolbar', 'events', 'culture', 'components', 'formats', 'messages', 'style', 'className', 'elementProps', 'toolbarProps', 'date', 'min', 'max']);
    ...
    return _react2.default.createElement(
      ...
      toolbar && _react2.default.createElement(CalToolbar, _extends({}, toolbarProps, {
        date: current,
        view: view,
        views: names,
        label: label,
      ...
      _react2.default.createElement(View, _extends({
        ...
        date: current,
        now: now,
        min: min || _dates2.default.startOf(now, 'day'),
        max: max || _dates2.default.endOf(now, 'day'),
...
Calendar.propTypes = {
   ...
   * @controllable onNavigate
   */
  now: _propTypes2.default.oneOfType([_propTypes2.default.instanceOf(Date), _propTypes2.default.func]),
