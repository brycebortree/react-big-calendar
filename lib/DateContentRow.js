...
var DateContentRow = function (_React$Component) {
  ...
  function DateContentRow() {
    ...
    _this.renderHeadingCell = function (date, index) {
      ...
      return renderHeader({
        ...
        className: (0, _classnames2.default)('rbc-date-cell', _dates2.default.eq(date, now, 'day') && 'rbc-now' // FIXME use props.now
        )
      });
    };
  ...
  DateContentRow.prototype.render = function render() {
    var _props = this.props,
        ...
        now = _props.now,
        props = _objectWithoutProperties(_props, ['date', 'rtl', 'events', 'range', 'className', 'selectable', 'renderForMeasure', 'startAccessor', 'endAccessor', 'renderHeader', 'minRows', 'maxRows', 'dateCellWrapper', 'eventComponent', 'eventWrapperComponent', 'onSelectStart', 'onSelectEnd', 'longPressThreshold', 'now']);
